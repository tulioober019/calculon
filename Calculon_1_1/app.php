    ...
    <table>
        ...
        <form method="get" action="" id="calc-cientifica" name="calc-cientifica">
            ...
            <tr>
                ...
                <td><button type="button" id="botonPI" name="botonPI" onclick="pantalla.value = pantalla.value + 'π'" class="botonOpAvanzadas">&pi;</button></td>
            ...
            <tr>
                <td><button type="button" id="botonCuad" name="botonCuad" onclick="pantalla.value = pantalla.value + '²'" class="botonOpAvanzadas">x&sup2;</button></td>
                <td><button type="button" id="botonCubo" name="botonCubo" onclick="pantalla.value = pantalla.value + '³'" class="botonOpAvanzadas">x&sup3;</button></td>
                <td><button type="button" id="botonSqrt" name="botonSqrt" onclick="pantalla.value = pantalla.value + '√('" class="botonOpAvanzadas">&Sqrt;</button></td>
                <td><button type="button" id="botonPow" name="botonPow" onclick="pantalla.value = pantalla.value + '^'" class="botonOpAvanzadas">xʸ</button></td>
            ...
            <?php
                $entrada = str_replace("√(","sqrt(",$entrada);
                $entrada = str_replace("²","^2",$entrada);
                $entrada = str_replace("³","^3",$entrada);
                $entrada = str_replace("π",pi(),$entrada);
